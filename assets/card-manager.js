...
(() => {
  ...
  // Browser security does not allow a website to silently choose an arbitrary
  // laptop folder. The normal browser download directory is used instead.
  // Each QR is saved as <CARD_CODE>.png immediately after card creation.
  function autoDownloadQrFiles(rows) {
