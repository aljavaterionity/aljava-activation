...
(() => {
  ...
  function enhanceButton(button) {
    ...
    const descriptions = {
      ...
      refreshmenu:'Muat data terbaru', resetmenu:'Reset data operasional', addaccountmenu:'Kelola akses admin', logoutmenu:'Akhiri sesi admin'
    };
  ...
  function clean() {
    ...
    ['dashboardMenu','salesMenu','cardsMenu','productMenu','customerMenu','operationsMenu'].forEach((id) => {
