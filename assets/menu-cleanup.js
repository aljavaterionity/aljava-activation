...
(() => {
  ...
  menuVisuals.href = '/assets/main-menu-icons.css?v=20260905-3';
  ...
  function styleMenu() {
    ...
    style.textContent = `
      ...
      /* FINAL ICON-ONLY OVERRIDE: this block is intentionally inline so it wins even if the external icon CSS is cached/blocked. */
      #menuPanel .menu-section .menu-icon,#menuPanel .menu-settings .menu-icon{
        ...
        border:1px solid transparent!important;color:rgba(255,255,255,.52)!important;
        box-shadow:none!important;filter:none!important;transform:none!important;
        transition:transform .2s ease,background .2s ease,border-color .2s ease,box-shadow .2s ease,color .2s ease,filter .2s ease!important;
      }
      #menuPanel .menu-section .menu-icon svg,#menuPanel .menu-settings .menu-icon svg{
      ...
      #menuPanel .menu-item:hover .menu-icon{
        transform:translateY(-1px)!important;background:rgba(255,255,255,.045)!important;
        border-color:rgba(255,255,255,.10)!important;box-shadow:0 0 12px rgba(255,255,255,.035)!important;filter:brightness(1.16)!important;
      }
      ...
      #menuPanel .menu-section .menu-item.active .menu-icon,#menuPanel .menu-settings .menu-item.active .menu-icon{
        flex:0 0 44px!important;width:44px!important;height:44px!important;margin:0!important;border-radius:50%!important;
        color:#fff!important;background:rgba(255,255,255,.10)!important;border:1px solid rgba(255,255,255,.24)!important;
      ...
      #menuPanel #operationsMenu.active .menu-icon{background:rgba(56,189,248,.14)!important;border-color:rgba(56,189,248,.30)!important;box-shadow:inset 0 1px 1px rgba(255,255,255,.10),0 0 20px rgba(56,189,248,.30),0 8px 18px rgba(0,0,0,.24)!important}
      ...
      @media(max-width:650px){
        #menuPanel .menu-section .menu-icon,#menuPanel .menu-settings .menu-icon{flex-basis:44px!important;width:44px!important;height:44px!important}
        #menuPanel .menu-section .menu-item.active .menu-icon,#menuPanel .menu-settings .menu-item.active .menu-icon{flex-basis:44px!important;width:44px!important;height:44px!important}
      }
    `;
